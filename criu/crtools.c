...
"  --file-validation METHOD\n"
			...
			"can be one of 'filesize', 'buildid' (default)\n"
			"'chksm', 'chksm-full' or 'chksm-period'.\n"
			"Alternatively, 'chksum', 'chksum-full' or\n"
			"'chksum-period can also be used.'.\n"
"  --chksm-parameter NUM pass the parameter required for certain\n"
			"checksum validation methods; default is 1024\n"
"\n"
"Check options:\n"
