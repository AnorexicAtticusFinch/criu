...
const char *test_doc	= "File validation test for build-id with 2 PT_NOTE header in a 64 bit ELF file (Should fail during restore)";
...
int main(int argc, char **argv)
{
	...
	Elf64_Phdr program_header, program_header_bid;
	Elf64_Nhdr note_header, note_header_bid;
